      ...
      <div class="card p-2 mb-2">
        <div class="card-body">
          <div class="image-card ">
            <img src="${this.image}" class="w-100 m-0" alt="" style="height: 180px;object-fit: cover"></div>
          <div>
            <p class="mt-4">${this.manufacture}/${this.type}</p>
          </div>
          <div>
            <h5 class="fw-bold">${new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", }).format(this.rentPerDay)} / hari</h5>
          </div>
          <div>
        ...
        <button class="mt-4 text-light btn-success" id="btn-success">Pilih Mobil</button>
      </div>
    </div>
  </div>
    `;
